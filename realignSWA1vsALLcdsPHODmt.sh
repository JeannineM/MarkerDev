...
OUTNAME=SWA1vsALLcdsPHODmt

#cd /scratch/nine/cov_musagenesAug14/mtalign/
#mkdir SWAvsALLcdsPHODmt
cd /scratch/nine/cov_musagenesAug14/mtalign/SWAvsALLcdsPHODmt
cp /scratch/nine/cov_musagenesAug14/mtalign/$TARGETref ./

mkdir $OUTNAME
cd /scratch/nine/cov_musagenesAug14/mtalign/SWAvsALLcdsPHODmt/$OUTNAME
